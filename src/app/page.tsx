      ...
      <div className="w-full h-full flex flex-col">
        ...
        <MainWrapper>
          ...
          <MainWrapper.Slider>
            ...
            >
              <p className="text-9xl font-medium text-primary-950">BRONYA</p>
            </div>
            <div className="w-full flex-none relative">
              <Image
                id="bronya"
        ...
        <div
          className={clsx(
            'fixed left-40 bottom-52 transition-all duration-500 delay-300',
            startAnimate && isImageLoad ? 'translate-x-0 opacity-100' : 'translate-x-[1000px] opacity-0',
            transFeatImageEnd ? 'fixed' : 'absolute'
          )}
        >
          <Slider></Slider>
        </div>
